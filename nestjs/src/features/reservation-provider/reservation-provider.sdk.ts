...
export type FindReservationProviderQueryVariables = Exact<{
  data: ReservationProviderFilter;
}>;


export type FindReservationProviderQuery = { __typename?: 'Query', reservation_provider?: Array<{ __typename?: 'reservation_provider', id?: string | null, name: string } | null> | null };


export const FindReservationProviderDocument = gql`
    query findReservationProvider($data: reservation_provider_filter!) {
  reservation_provider(filter: $data) {
    id
    name
  }
}
...
const FindReservationProviderDocumentString = print(FindReservationProviderDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    findReservationProvider(variables: FindReservationProviderQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: FindReservationProviderQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<FindReservationProviderQuery>(FindReservationProviderDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'findReservationProvider', 'query');
    }
  };
}
